...
public class MailItem {
	...
	/**
	 * @return String containing MailItem's ID, Destination floor, and Arrival
	 *         time
	 */
	@Override
	public String toString() {
		return "Mail Item: " + "| ID: " + ID + "| Destination: "
				+ DESTINATION_FLOOR + "| Arrival: " + ARRIVAL_TIME;
	}
	 ...
	 * priority levels.
	 * 
	 * @return 0 as default priority level. Overridden by prioritymailitem
