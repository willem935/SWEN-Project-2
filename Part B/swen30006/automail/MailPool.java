...
public class MailPool implements IMailPool {
	...
	/** Non priority mail pool waiting to be delivered */
	private ArrayList<MailItem> nonPriorityPool;

	/** Priority mail pool waiting to be delivered */
	...
	/**
	 * Adds a mailItem to one of the two mailPool ArrayLists based on whether it
	 * is a PriorityMailItem or not. Once added, addToPool calls the .sort()
	 * method available to ArrayLists, giving the appropriate comparator as an
	 * argument, so that the highest priority / earliest arriving items of each
	 * pool are closest to the head.
	 * 
	 * @param mailItem
	 *            mailItem instance to be added
	 * 
	 */
	...
	/**
	 * Returns the MailItem at the head of the nonPriorityPool if one exists, or
	 * null if not.
	 */
	...
	/**
	 * Returns the MailItem at the head of the PriorityPool if one exists, or
	 * null if not.
	 */
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// getBestMail unused in our current setup. left code here in case it
	////////////////////////////////////////////////////////////////////////////////////////////////////////////// becomes
	////////////////////////////////////////////////////////////////////////////////////////////////////////////// more
	////////////////////////////////////////////////////////////////////////////////////////////////////////////// useful
	////////////////////////////////////////////////////////////////////////////////////////////////////////////// in
	...
	public MailItem getBestMail(int FloorFrom, int FloorTo) {
		...
		// If there is already something in priority then return it as the best
		// mail
		if (tempPriority.size() > 0) {
			// Since priorityPool is already sorted, that means items being
			// added are already sorted with the
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// isWithinRange unused in our current setup. left code here in case it
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////// becomes
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////// more
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////// useful
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////// in
	...
	/**
	 * Comparator classes and helper method Used by the ArrayList class's sort()
	 * function
	 */
	private class PriorityComparer implements Comparator<MailItem> {
		// Compare Priority level, if they are the same, try comparing arrival
		// time
		public int compare(MailItem m1, MailItem m2) {
			if (((PriorityMailItem) m1)
					.getPriorityLevel() > ((PriorityMailItem) m2)
							.getPriorityLevel()) {
				return -1;
			} else if (((PriorityMailItem) m1)
					.getPriorityLevel() == ((PriorityMailItem) m2)
							.getPriorityLevel()) {
	...
	/**
	 * Checks when two MailItems arrived and returns an int to indicate which is
	 * oldest
	 * 
	 * @param m1
	 *            MailItem to compare
	 * @param m2
	 *            MailItem to compare against
